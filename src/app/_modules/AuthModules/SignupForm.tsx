...
import { COURIER, CUSTOMER, LOGIN, RESTAURANT } from "@utils/links";
  ...
  },
  {
    ...
    rules: {
      ...
      validate: (value, allValues) =>
        value === allValues?.password || "گذرواژه‌ها باید مطابقت داشته باشند.",
    },
  },
];
    ...
    <div className="flex flex-col w-full">
      <div className="bg-white rounded-b-lg p-6">
        ...
        <p className="text-sm mt-10 mb-8">
          لطفاً اطلاعات خواسته‌شده را برای ایجاد حساب کاربری خود وارد کنید.
        </p>
        <form>
          {fields.map((field) => (
            <Controller
        ...
        <div className="flex items-center justify-between w-full mt-4">
          ...
          <Link href={LOGIN} className="text-sm text-primary hover:text-brand">
            ورود
          </Link>
        </div>
      </div>
