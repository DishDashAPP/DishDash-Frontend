...
import { getRestaurantActiveOrdersReq, getRestaurantOrderHistoryReq } from '@api/services/restaurantService'
...
const OrderList: FC = () => {
    ...
    if (loading) {
        return <div className="my-8 text-base animate-pulse">در حال دریافت اطلاعات...</div>
    }
