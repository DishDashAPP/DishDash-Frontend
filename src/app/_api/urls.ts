...
export const CUSTOMER_ORDER = {
  CREATE_ORDER: (restaurantOwnerId: string) =>
    `/order/customer?restaurantOwnerId=${restaurantOwnerId}`,
  CREATE_SHOPPING_CART: (restaurantOwnerId: string) =>
    `/order/customer?restaurantOwnerId=${restaurantOwnerId}`, //TODO: change this
  MODIFY_ORDER: (orderId: string) =>
    `/order/customer/modifyOrder?orderId=${orderId}`,
  MODIFY_SHOPPING_CART: (orderId: string) =>
    `/order/customer/modifyOrder?orderId=${orderId}`, //TODO: change this
